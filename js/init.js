...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			narrow:		{ range: '641-1200', href: 'css/style-narrow.css' },
			narrower:	{ range: '641-1000', href: 'css/style-narrower.css' },
			mobile:		{ range: '-640', href: 'css/style-mobile.css', lockViewport: true, grid: { collapse: true } }
		}
	}, {
		layers: {
			layers: {
